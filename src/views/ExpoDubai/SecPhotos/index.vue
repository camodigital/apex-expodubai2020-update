    ...
    <div class="secPhotos__container">
      <header class="secPhotos__header">
        <h1
          ...
          v-html="$t('apiExpodubai.galery_title')"
        ></h1>
      </header>
